    ...
    server.on("/api/reprovision", HTTP_GET, []() {
        ...
        server.send(200, "text/html",
            F("<!DOCTYPE html><html><head>"
              ...
              "<div class='container'>"
              "<div class='header'>"
              "<svg width='36' height='36' viewBox='0 0 64 64'><circle cx='32' cy='32' r='30' fill='#1a1a2e'/>"
              "<g fill='#FFD93D' stroke='#FFD93D' stroke-width='2' stroke-linecap='round'>"
              "<line x1='32' y1='8' x2='32' y2='15'/><line x1='49' y1='15' x2='44' y2='20'/>"
              "<line x1='56' y1='32' x2='49' y2='32'/><line x1='49' y1='49' x2='44' y2='44'/>"
              "<line x1='32' y1='56' x2='32' y2='49'/><line x1='15' y1='49' x2='20' y2='44'/>"
              "<line x1='8' y1='32' x2='15' y2='32'/><line x1='15' y1='15' x2='20' y2='20'/></g>"
              "<defs><radialGradient id='sg' cx='40%' cy='40%'><stop offset='0%' stop-color='#FFE66D'/>"
              "<stop offset='100%' stop-color='#FFD93D'/></radialGradient></defs>"
              "<circle cx='32' cy='32' r='14' fill='url(#sg)'/>"
              "<circle cx='27' cy='29' r='2' fill='#FF9500'/><circle cx='37' cy='29' r='2' fill='#FF9500'/>"
              "<path d='M26 36Q32 42 38 36' stroke='#FF9500' stroke-width='2' fill='none' stroke-linecap='round'/></svg>"
              "<h1><span style='color:#00d4ff'>Epic</span><span style='color:#fff'>WeatherBox</span></h1>"
              "</div>"
